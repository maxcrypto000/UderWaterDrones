...
void setDefaultStartValues(ModelInstance *comp) {
  ...
  put_real_element(10.0, 0, &comp->fmuData->modelData->realParameterData[0].attribute.start);
  put_real_element(100.0, 0, &comp->fmuData->modelData->realParameterData[1].attribute.start);
  put_real_element(0.01, 0, &comp->fmuData->modelData->realParameterData[2].attribute.start);
  put_real_element(5.0, 0, &comp->fmuData->modelData->realParameterData[3].attribute.start);
  put_real_element(15.0, 0, &comp->fmuData->modelData->realParameterData[4].attribute.start);
  put_real_element(0.05, 0, &comp->fmuData->modelData->realParameterData[5].attribute.start);
  put_real_element(10.0, 0, &comp->fmuData->modelData->realParameterData[6].attribute.start);
...
fmi2ValueReference mapInitialUnknownsIndependentIndex(const fmi2ValueReference vr) {
    switch (vr) {
      ...
      case 31: return 9; break;
      case 32: return 10; break;
      case 33: return 11; break;
      case 34: return 12; break;
      case 35: return 13; break;
      case 36: return 14; break;
      case 37: return 15; break;
      default:
        return -1;
    }
}
