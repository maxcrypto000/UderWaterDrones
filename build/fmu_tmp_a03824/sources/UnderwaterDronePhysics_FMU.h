#ifndef UnderwaterDronePhysics_FMU_H
#define UnderwaterDronePhysics_FMU_H

#include "simulation_data.h"

// define class name and unique id
#define MODEL_IDENTIFIER UnderwaterDronePhysics
#define MODEL_GUID "{4b83fcdb-ab46-4a8a-8077-31450b36403f}"
...
#define STATES { 0, 1, 2, 3, 4, 5, 6 }
#define STATESDERIVATIVES { 7, 8, 9, 10, 11, 12, 13 }
...
extern void UnderwaterDronePhysics_setupDataStruc(DATA *data, threadData_t *threadData);
#define fmu2_model_interface_setupDataStruc UnderwaterDronePhysics_setupDataStruc
#include "fmi-export/fmu2_model_interface.h"
#include "fmi-export/fmu_read_flags.h"

#define FMI2_FUNCTION_PREFIX UnderwaterDronePhysics_
...
#endif /* UnderwaterDronePhysics_FMU_H */