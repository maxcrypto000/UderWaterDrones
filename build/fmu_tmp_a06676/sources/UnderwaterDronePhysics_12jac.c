...
int UnderwaterDronePhysics_initialAnalyticJacobianA(DATA* data, threadData_t *threadData, JACOBIAN *jacobian)
{
  ...
  initJacobian(jacobian, 6, 6, 0, NULL, UnderwaterDronePhysics_functionJacA_column, NULL, NULL);
  jacobian->sparsePattern = allocSparsePattern(6, 12, 3);
  ...
  readSparsePatternColor(threadData, pFile, jacobian->sparsePattern->colorCols, 3, 4, 6);
